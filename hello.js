...
console.log("The answer to 5 + 3 is 8");
...
Modify your code on line 7 to try to accomplish the tasks listed below:
   ...
   3. Remove one or both quotation marks. Do we need to include both opening and closing quote marks? Is there a difference between using a single or a double quote (' vs. ")? Yes, need to include both closing and opening.
